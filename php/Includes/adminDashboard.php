    ...
    <div class="row">
        ...
        <div class="col custom-dash-cols">
            ...
            <div class="d-grid gap-2">
                <button type="button" class="btn-dashboard" onclick='window.location.href = "productSales.php"'>Product
                    sales</button>
        ...
        <div class="col custom-dash-cols">
            ...
            <hr>
            <div class="d-grid gap-2">
                <button type="button" class="btn-dashboard" onclick='window.location.href = "addNewProduct.php"'>Add new
                    product</button>
                <button type="button" class="btn-dashboard" onclick='window.location.href = "removeProduct.php"'>Remove
                    product</button>
            </div>
        </div>
    </div>
